...
def FRQ_3_a():
    ...
    images, labels = load_mnist(dataset= 'testing', path=r"C:\Users\wujingyu\OneDrive - HKUST Connect\Documents\交换\Northwestern University\year3_spring\CS_349\hw\winter2022-hw3-clustering-ElaineWu66\data")
    ...
    # diag_score = adjusted_mutual_info(model_labels, all_training_labels)
    # print("diag_score: ", diag_score)
    ...
    # spherical_score = adjusted_mutual_info(model_labels, all_training_labels)
    # print("spherical score: ", spherical_score)
